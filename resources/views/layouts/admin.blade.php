    ...
    $(document).ready(function () {
        ...
        if (url.includes("/admin/users")) {
            ...
            if (url.includes("profile")) {
                document.getElementById('card-nav-profile').classList.add('active');
                document.getElementById('form-control-profile').classList.add('bg-white');
            }
            if (url.includes("ads")) {
                document.getElementById('card-nav-ads').classList.add('active');
                document.getElementById('form-control-ads').classList.add('bg-white');
            }
            if (url.includes("orders")) {
                document.getElementById('card-nav-orders').classList.add('active');
                document.getElementById('form-control-orders').classList.add('bg-white');
            }
            if (url.includes("requests")) {
                document.getElementById('card-nav-requests').classList.add('active');
                document.getElementById('form-control-requests').classList.add('bg-white');
            }
            if (url.includes("finance")) {
                document.getElementById('card-nav-finance').classList.add('active');
                document.getElementById('form-control-finance').classList.add('bg-white');
            }
        }
...
<script>
    ...
    function ClearOptions() {
        var selectObj = $('#city-select');
        selectObj.find('option').remove().end().append('<option value="0"></option>');
    }
</script>
<script>
    function sendFromAdmin(e) {

        var hiddenInput = $('#send-ticket-user-id');
        if (hiddenInput.val()=="null") {
            event.preventDefault();
            alert("لطفا یک چت راانخاب کنید.");
