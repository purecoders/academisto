                    ...
                    <div class="swiper-slide">
                        <div id="request_card" class="card rtl">
                            ...
                            <div class="card-footer d-flex justify-content-between p-1">
                                ...
                                @elseif($request['projects']['is_started'] == 1 && $request['project_request']['is_accepted'] == 1 && $request['projects']['is_finished'] == 0)
                                @else
                                    <form class="mr-auto d-inline-block" method="post" action="{{route('project-request.destroy', $request['project_request']['id'])}}">
                                        {{csrf_field()}}
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input class="form-control py-1 m-1 btn btn-danger" type="submit" value="لغو درخواست">
                                    </form>
                                @endif
