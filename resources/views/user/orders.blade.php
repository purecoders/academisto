                    ...
                    <div class="swiper-slide">
                        <div id="project_card"
                            ...
                            <div class="d-flex justify-content-between p-0">
                                <a href="{{route('user-order-detail',$project->id)}}"
                                   class="py-1 m-1 btn btn-outline-secondary">مشاهده جزئیات</a>

                                <div class="mt-2 mr-1">
                                    @if($project->is_immediate == 1)
                                        <alert class="alert alert-danger p-0 mt-1 px-1">فوری</alert>
                                    @endif
                                </div>
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center p-1">
                                @if($project->is_started == 0)
                                    <a href="{{route('user-order-edit',$project->id)}}" class="btn btn-primary m-2">ویرایش
                                        پروژه</a>
                                    <form class="m-1" method="post" action="{{route('project.destroy', $project->id)}}">
                                        {{csrf_field()}}
