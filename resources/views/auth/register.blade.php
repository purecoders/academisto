        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body rtl">
                    <form class="rtl" method="POST" action="{{ route('register') }}" aria-label="ثبت نام">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="phone-number" class="col-md-4 col-form-label text-md-right">شماره موبایل </label>
                        ...
                        <div class="form-group row mb-0 rtl">
